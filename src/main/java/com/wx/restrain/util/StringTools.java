...
public class StringTools {
    ...
    static public <T> List<T> convertToListObject(String msg, Class<T> type) {
        ObjectMapper mapper = new ObjectMapper();
        try {
            mapper.configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false);
            return mapper.readValue(msg, mapper.getTypeFactory().constructParametricType(ArrayList.class, type));
        } catch (IOException e) {
        }
        return null;
    }
